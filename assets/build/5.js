...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__game__ = __webpack_require__(278);
    ...
    GamePage.prototype.loadGameServices = function () {
        ...
        window["UnityProgress"] = function (gameInstance, progress) {
            ...
            if (calc == 0) {
                ...
                window["gameInstance"].SendMessage("Web3Init", "SetDisplayName", _this.appState.username || _this.appState.account.substring(0, 5));
            }
