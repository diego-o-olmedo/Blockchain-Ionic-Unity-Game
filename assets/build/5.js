...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__game__ = __webpack_require__(277);
...
var GamePage = (function () {
    ...
    GamePage.prototype.joinRoom = function (room) {
        ...
        io.socket.post("/api/v1/chat/join", { room: room }, function () {
            ...
            _this.msgs.push({
                text: _this.appState.account.substring(0, 5) + " connected to chat"
            });
            if (!_this.listening) {
    ...
    GamePage.prototype.loadGameServices = function () {
        ...
        window["UnityProgress"] = function (gameInstance, progress) {
            ...
            if (calc == 0) {
                ...
                window["gameInstance"].SendMessage("Web3Init", "SetDisplayName", _this.appState.username);
            }
